...
- audio-based interaction (existing audio search, audio recording search)
...
```
    git clone --recurse-submodules git@github.com:l-ablaoui/IQVN.git
```
...
[ImageBind](https://github.com/facebookresearch/ImageBind) (under `assets/ImageBind`)
  ...
  - This repository only references ImageBind as a git submodule.
