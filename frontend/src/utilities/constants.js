...
export const TIME_END_COLOR = {red: 68, green: 53, blue: 91}; // very light pink
export const LOW_SCORE_COLOR = {red: 255, green: 0, blue: 0}; // red
export const HIGH_SCORE_COLOR = {red: 0, green: 200, blue: 0}; // green
export const DEACTIVATED_COLOR = "rgba(0, 0, 0, 0.5)"; // black
